...
setup(name='QubeSpec',
      ...
      package_data={'': ['detection/Detection.py','Model/Custom_model.py','Models/FeII_comp.py','Models/Halpha_models.py','Models/Halpha_OIII_models.py','Models/OIII_models.py','Models/QSO_models.py',
